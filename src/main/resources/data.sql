...
true); -- Inserir produtos 
INSERT INTO produtos (nome, descricao, preco, categoria, disponivel, restaurante_id) VALUES -- Pizzaria Bella 
...
('Lasanha Bolonhesa', 'Lasanha tradicional com molho bolonhesa', 28.90, 'Massa', true, 1), -- Burger House 
...
('Batata Frita', 'Porção de batata frita crocante', 12.90, 'Acompanhamento', true, 2), -- Sushi Master 
...
('Temaki Atum', 'Temaki de atum com cream cheese', 15.90, 'Temaki', true, 3); -- Inserir pedidos de exemplo 
...
('PED1234567892', NOW(), 'ENTREGUE', 78.80, 'Wasabi à parte', 3, 3); -- Inserir itens dos pedidos 
INSERT INTO itens_pedido (quan dade, preco_unitario, subtotal, pedido_id, produto_id) 
VALUES -- Pedido 1 (João - Pizzaria Bella) 
(1, 35.90, 35.90, 1, 1), -- Pizza Margherita 
(1, 28.90, 28.90, 1, 3), -- Lasanha -- Pedido 2 (Maria - Burger House) 
(1, 22.90, 22.90, 2, 5), -- X-Bacon 
(1, 18.90, 18.90, 2, 4), -- X-Burger -- Pedido 3 (Pedro - Sushi Master) 
